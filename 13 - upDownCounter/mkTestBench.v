...
//
// On Sun May 30 11:30:51 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkTestBench(CLK,
  ...
  wire MUX_counter_counter$write_1__SEL_1, MUX_counter_counter$write_1__SEL_2;

  // remaining internal signals
  wire [4 : 0] SEXT_counter_counter_PLUS_24___d20,
	       SEXT_counter_counter_PLUS_28___d42,
	       SEXT_counter_counter_PLUS_2___d5,
	       SEXT_counter_counter_PLUS_4___d31,
  ...
  assign MUX_counter_counter$write_1__SEL_2 = step == 32'd3 || step == 32'd2 ;
  ...
  assign MUX_counter_counter$write_1__VAL_2 =
	     ((SEXT_counter_counter_PLUS_24___d20 ^ 5'h10) <= 5'd23) ?
	       (((SEXT_counter_counter_PLUS_24___d20 ^ 5'h10) < 5'd8) ?
		  4'd8 :
		  SEXT_counter_counter_PLUS_24___d20[3:0]) :
	       4'd7 ;
  ...
  assign MUX_counter_counter$write_1__VAL_4 =
	     ((SEXT_counter_counter_PLUS_4___d31 ^ 5'h10) <= 5'd23) ?
	       (((SEXT_counter_counter_PLUS_4___d31 ^ 5'h10) < 5'd8) ?
		  4'd8 :
		  SEXT_counter_counter_PLUS_4___d31[3:0]) :
	       4'd7 ;
  assign MUX_counter_counter$write_1__VAL_5 =
	     ((SEXT_counter_counter_PLUS_28___d42 ^ 5'h10) <= 5'd23) ?
	       (((SEXT_counter_counter_PLUS_28___d42 ^ 5'h10) < 5'd8) ?
		  4'd8 :
		  SEXT_counter_counter_PLUS_28___d42[3:0]) :
	       4'd7 ;

  // register counter_counter
  always@(MUX_counter_counter$write_1__SEL_1 or
	  MUX_counter_counter$write_1__VAL_1 or
	  MUX_counter_counter$write_1__SEL_2 or
	  MUX_counter_counter$write_1__VAL_2 or
	  step or
	  MUX_counter_counter$write_1__VAL_3 or
	  WILL_FIRE_RL_r4 or
	  MUX_counter_counter$write_1__VAL_4 or
	  WILL_FIRE_RL_r6 or MUX_counter_counter$write_1__VAL_5)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_counter_counter$write_1__SEL_1:
	  counter_counter$D_IN = MUX_counter_counter$write_1__VAL_1;
      MUX_counter_counter$write_1__SEL_2:
  ...
  assign counter_counter$EN =
	     WILL_FIRE_RL_r5 || step == 32'd1 || step == 32'd3 ||
	     step == 32'd2 ||
	     step == 32'd0 ||
	     WILL_FIRE_RL_r4 ||
	     WILL_FIRE_RL_r6 ;
