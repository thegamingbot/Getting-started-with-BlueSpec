...
//
// On Fri Apr  9 22:35:43 IST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkTb(CLK,
  ...
  assign int16$D_IN =
	     int16[15] ?
	       ...
	       IF_int16_2_BIT_15_3_THEN_NEG_int16_2_4_ELSE_in_ETC___d16 ;
  assign int16$EN = step == 32'd1 ;

  // register step
  assign step$D_IN = step + 32'd1 ;
  assign step$EN =
	     step == 32'd3 || step == 32'd2 || step == 32'd1 ||
	     step == 32'd0 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd0)
	$display("%x < %x == %x (unsigned)",
		 $unsigned(16'd0),
		 $unsigned(16'hFFFF),
		 1'd1);
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd1) $display("\n== step 1 ==");
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd1) $display("maxInt16 = %x", $signed(16'd32767));
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd1) $display("minInt16 = %x", $signed(16'd32768));
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd1)
	$display("%x < %x == %x (signed)",
		 $signed(16'd32768),
		 $signed(16'd32767),
		 1'd1);
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd1) $display("maxInt16/4 = %x", $signed(16'd8191));
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd2) $display("\n== step 2 ==");
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd2) $display("foo is 32 bits = %b", $signed(32'd10));
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd2) $display("this is 1 bit = %b", 1'd1);
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd3) $display("\n== step 3 ==");
    if (RST_N != `BSV_RESET_VALUE) if (step == 32'd3) $display("b1 is True");
    if (RST_N != `BSV_RESET_VALUE)
      if (step == 32'd3) $display("onebit is a 1");
    if (RST_N != `BSV_RESET_VALUE) if (step == 32'd4) $display("\n=== ===");
    if (RST_N != `BSV_RESET_VALUE) if (step == 32'd4) $display("All done");
