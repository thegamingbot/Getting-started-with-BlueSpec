...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_fill;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_fill;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_empty;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_empty;
	 DEF_INST_top_DEF_CAN_FIRE_RL_empty = INST_top.INST_myFIFO.METH_i_notEmpty();
	 DEF_INST_top_DEF_WILL_FIRE_RL_empty = DEF_INST_top_DEF_CAN_FIRE_RL_empty;
	 DEF_INST_top_DEF_CAN_FIRE_RL_fill = INST_top.INST_myFIFO.METH_i_notFull();
	 DEF_INST_top_DEF_WILL_FIRE_RL_fill = DEF_INST_top_DEF_CAN_FIRE_RL_fill;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_fill)
	   INST_top.RL_fill();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_empty)
	   INST_top.RL_empty();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_myFIFO.rst_tick_clk((tUInt8)1u);
	 }
       };
...
void MODEL_mkTestbench::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTestbench_instance->INST_myFIFO.set_clk_0)("CLK");
...
time_t MODEL_mkTestbench::get_creation_time()
{
  ...
  /* Thu May 27 15:39:03 UTC 2021 */
  return 1622129943llu;
}
